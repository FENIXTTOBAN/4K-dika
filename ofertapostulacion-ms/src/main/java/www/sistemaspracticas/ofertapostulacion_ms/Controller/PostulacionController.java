...
import www.sistemaspracticas.ofertapostulacion_ms.Services.PostulacionService;
...
public class PostulacionController {
    ...
    public ResponseEntity<Postulacion> registrar(@RequestBody Postulacion postulacion) {
        log.info("Registrando nueva postulación con persona ID: {}", postulacion.getPersonaId());
